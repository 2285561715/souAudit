...
@Component({
  selector: 'app-dashboard-dataup-zxtbk21-index',
  templateUrl: './index.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DashboardDataUpZxtbK21IndexComponent implements OnInit {
  constructor(
  ...
  ngOnInit(): void {
    this.upUrl = '/api/excel/import?tableName=sjzxtb_k21_rcpygm&appId=17&stepId=21&deptId=' + this.loadUser.user.bid;
    this.loadInfo();
  }
  loadInfo(): void {
    this.listOfData = [];
    ...
    this.http
      .put(
        `/api/data/tables/entry?id=` +
          id +
          `&tableno=sjzxtb_k21_rcpygm&appId=17&stepId=21&deptId=` +
