...
export class DashboardDataUpFxtbB18IndexComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.upUrl = '/api/excel/import?tableName=sjzxtb_k18_dzts&appId=18&stepId=29&deptId=' + this.loadUser.user.bid;
    this.loadInfo();
  }
    ...
    this.http
      .put(
        `/api/data/tables/entry?id=` +
          id +
          `&tableno=sjzxtb_k18_dzts&appId=18&stepId=29&deptId=` +
