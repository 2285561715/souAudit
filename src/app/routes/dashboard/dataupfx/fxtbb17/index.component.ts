...
export class DashboardDataUpFxtbB17IndexComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.upUrl = '/api/excel/import?tableName=sjfxtb_b11_sysx&appId=18&stepId=29&deptId=' + this.loadUser.user.bid;
    this.loadInfo();
  }
    ...
    this.http
      .put(
        `/api/data/tables/entry?id=` +
          id +
          `&tableno=sjfxtb_b11_sysx&appId=18&stepId=29&deptId=` +
