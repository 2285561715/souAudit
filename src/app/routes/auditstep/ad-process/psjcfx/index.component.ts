...
import { AuditstepAdProcessPsjcFxDataViewComponent } from './dataview.component';

@Component({
  selector: 'app-auditstep-ad-process-psjcfx-index',
  templateUrl: './index.component.html',
})
export class AuditstepAdProcessPsjcFxIndexComponent implements OnInit {
  constructor(
  ...
  dataBarShow(record: any): void {
    this.modal.create(AuditstepAdProcessPsjcFxDataViewComponent, { size: 'xl' }).subscribe((res: any) => {});
  }
}
