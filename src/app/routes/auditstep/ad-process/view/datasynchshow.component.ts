...
@Component({
  selector: 'app-auditstep-ad-process-view-data-synch-show',
  templateUrl: './datasynchshow.component.html',
})
export class AuditstepAdProcessViewDataSynchShowComponent implements OnInit {
  tableNo: string;
