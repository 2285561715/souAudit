...
@Component({
  selector: 'app-stepprocess-tbjcfx-fxtbb054-index',
  templateUrl: './index.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class StepProcessTbjcFxtbB054IndexComponent implements OnInit {
  constructor(
  ...
  loadInfo(): void {
    ...
    this.parmOfSql = {
      ...
      fieldList: ['id', 'nd', 'xxdm', 'xxmc', 'xm', 'zgh', 'birdate', 'xb', 'gzxz', 'xl', 'islock'],
