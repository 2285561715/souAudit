...
@Component({
  selector: 'app-stepprocess-tbjcfx-fxtbb191-index',
  templateUrl: './index.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class StepProcessTbjcFxtbB191IndexComponent implements OnInit {
  constructor(
  ...
  loadInfo(): void {
    ...
    this.parmOfSql = {
      ...
      fieldList: ['id', 'nd', 'xxdm', 'xxmc', 'jxmc', 'jxlb', 'sjdw', 'sjnd', 'islock'],
