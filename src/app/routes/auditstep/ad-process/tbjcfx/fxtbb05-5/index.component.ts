...
@Component({
  selector: 'app-stepprocess-tbjcfx-fxtbb055-index',
  templateUrl: './index.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class StepProcessTbjcFxtbB055IndexComponent implements OnInit {
  constructor(
  ...
  loadInfo(): void {
    ...
    this.parmOfSql = {
      ...
      fieldList: ['id', 'nd', 'xxdm', 'xxmc', 'bmmc', 'glnum', 'zznum', 'fxljss', 'jzjss', 'islock'],
