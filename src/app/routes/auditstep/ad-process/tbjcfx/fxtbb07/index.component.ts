...
@Component({
  selector: 'app-stepprocess-tbjcfx-fxtbb07-index',
  templateUrl: './index.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class StepProcessTbjcFxtbB07IndexComponent implements OnInit {
  constructor(
  ...
  loadInfo(): void {
    ...
    this.parmOfSql = {
      ...
      fieldList: ['id', 'nd', 'xxdm', 'xxmc', 'xmmc', 'jgmc', 'bxgm', 'dwmc', 'hzxz', 'remark', 'islock'],
  ...
  deleteInfo() {
    const subData = {
      tableName: this.dataStr.dtNo,
      predication: 'islock=0 and xxdm=' + this.dataStr.deptId ,
    };
