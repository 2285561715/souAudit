...
@Component({
  selector: 'app-stepprocess-tbjcfx-fxtbb101-index',
  templateUrl: './index.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class StepProcessTbjcFxtbB101IndexComponent implements OnInit {
  constructor(
  ...
  loadInfo(): void {
    ...
    this.parmOfSql = {
      ...
      fieldList: ['id', 'nd', 'xq', 'xxdm', 'xxmc', 'zymc', 'kcmc', 'jsxm', 'mskzcs', 'cql', 'islock'],
