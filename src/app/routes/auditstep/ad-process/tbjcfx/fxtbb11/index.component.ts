...
@Component({
  selector: 'app-stepprocess-tbjcfx-fxtbb11-index',
  templateUrl: './index.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class StepProcessTbjcFxtbB11IndexComponent implements OnInit {
  constructor(
  ...
  loadInfo(): void {
    ...
    this.parmOfSql = {
      ...
      fieldList: ['id', 'nd', 'xq', 'xxdm', 'xxmc', 'kcmc', 'lx', 'lb', 'ywcrc', 'sjwcrc', 'islock'],
