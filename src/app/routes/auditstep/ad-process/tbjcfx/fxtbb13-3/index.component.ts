...
@Component({
  selector: 'app-stepprocess-tbjcfx-fxtbb133-index',
  templateUrl: './index.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class StepProcessTbjcFxtbB133IndexComponent implements OnInit {
  constructor(
  ...
  loadInfo(): void {
    ...
    this.parmOfSql = {
      ...
      fieldList: ['id', 'nd', 'xxdm', 'xxmc', 'jxmc', 'hjz', 'sjdw', 'sjnd', 'jxlb', 'jxdj', 'islock'],
