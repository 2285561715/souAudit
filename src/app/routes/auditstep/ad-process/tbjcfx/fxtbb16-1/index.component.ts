...
@Component({
  selector: 'app-stepprocess-tbjcfx-fxtbb161-index',
  templateUrl: './index.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class StepProcessTbjcFxtbB161IndexComponent implements OnInit {
  constructor(
  ...
  loadInfo(): void {
    ...
    this.parmOfSql = {
      ...
      fieldList: ['id', 'nd', 'xxdm', 'xxmc', 'zjjcs', 'gjjcs', 'dmtjcs', 'webzys', 'islock'],
