...
@Component({
  selector: 'app-auditindex-index-file-add',
  templateUrl: './add.component.html',
})
export class AuditindexIndexFileAddComponent implements OnInit {
  record: any = {};
  i: any;
  schema: SFSchema = {
    properties: {
      ...
      status: { type: 'boolean', title: '是否在用', default: true },
    },
  ...
  save(value: any) {
    ...
    console.log(value);
    this.http.post(`http://139.224.62.102:8080/api/main/infos`, value).subscribe(res => {
